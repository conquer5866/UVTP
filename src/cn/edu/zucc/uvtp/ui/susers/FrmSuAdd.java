...
public class FrmSuAdd extends JDialog implements ActionListener {
	...
	public FrmSuAdd(JFrame x, String s, boolean b) {
		super(x,s,b);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == this.b_Cancel){
			...
			try {
				(new SysUsersManager()).create(suname,supwd1,supwd2);
				this.setVisible(false);
				return ;
