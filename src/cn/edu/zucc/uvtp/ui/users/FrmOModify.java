...
public class FrmOModify  extends JDialog implements ActionListener {
	...
	public FrmOModify(JFrame x, String s, boolean b,Orders o) {
		super(x,s,b);
	    ...
	    this.addMouseMotionListener(mouseListener);*/
	  	...
	  	if(o.getOType() == 1){
	  		c_n1.setSelected(true);
	  		c_n2.setSelected(false);
	  		c_n3.setSelected(false);
	  	}
	  	else if(o.getOType() == 2){
	  		c_n1.setSelected(false);
	  		c_n2.setSelected(true);
	  		c_n3.setSelected(false);
	  	}
	  	...
	  	else if(o.getOType() == 4){
	  		c_n1.setSelected(false);
	  		c_n2.setSelected(false);
	  		c_n3.setSelected(true);
	  	}
	  	else if(o.getOType() == 5){
	  		c_n1.setSelected(true);
	  		c_n2.setSelected(false);
	  		c_n3.setSelected(true);
	  	}
	  	else if(o.getOType() == 6){
	  		c_n1.setSelected(false);
	  		c_n2.setSelected(true);
	  		c_n3.setSelected(true);
	  	}
	  	else if(o.getOType() == 7){
	  		c_n1.setSelected(true);
	  		c_n2.setSelected(true);
	  		c_n3.setSelected(true);
	  	}
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == this.b_Cancel){
			...
			this.o1.setOType(x);
			try {
				(new OrdersManager()).modify(this.o1);
				this.setVisible(false);
				return;
