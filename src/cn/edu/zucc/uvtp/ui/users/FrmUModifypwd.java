...
public class FrmUModifypwd  extends JDialog implements ActionListener {
	...
	public FrmUModifypwd(JFrame x, String s, boolean b) {
		super(x,s,b);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == this.b_Cancel){
			...
			try {
				new UsersManager().modifyPwd(supwd, supwd1, supwd2);
				this.setVisible(false);
				new FrmLogin();
